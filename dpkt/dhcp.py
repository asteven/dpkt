...
if __name__ == '__main__':
    ...
    class DHCPTestCast(unittest.TestCase):
        ...
        def test_discover(self):
            data = ''
            import binascii
            s = binascii.a2b_hex(data)
            dhcp = DHCP(s)
            self.failUnless(s == str(dhcp))
            print(dhcp.opts)
    unittest.main()
